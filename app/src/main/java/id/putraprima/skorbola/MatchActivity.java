...
public class MatchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reset = findViewById(R.id.btn_reset_skor);
        result = findViewById(R.id.btn_hasil);
        homeScore = findViewById(R.id.score_home);
        awayScore = findViewById(R.id.score_away);
        add_home_satu = findViewById(R.id.btn_tambah_home_1);
        add_home_dua = findViewById(R.id.btn_tambah_home_2);
        add_home_tiga = findViewById(R.id.btn_tambah_home_3);
        add_away_satu = findViewById(R.id.btn_tambah_away_1);
        add_away_dua = findViewById(R.id.btn_tambah_away_2);
        add_away_tiga = findViewById(R.id.btn_tambah_away_3);
